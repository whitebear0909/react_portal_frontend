...
const SalesStatistics: React.FC<Props> = ({className, chartColor, chartHeight, strokeColor}) => {
        ...
        <div className='card-p mt-n20 position-relative'>
          ...
          <div className='row g-0'>
            ...
            <div className='col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7'>
              ...
              />
              <a href='/statistics/sales-quotes' className='text-warning fw-bold fs-6'>
                Sales Quotes
              </a>
            </div>
            {/* end::Col */}
            ...
            <div className='col bg-light-primary px-6 py-8 rounded-2 mb-7'>
              ...
              />
              <a href='/statistics/sales-orders' className='text-primary fw-bold fs-6'>
                Sales Orders
              </a>
            </div>
            {/* end::Col */}
          ...
          <div className='row g-0'>
            ...
            <div className='col bg-light-danger px-6 py-8 rounded-2 me-7'>
              ...
              />
              <a href='/statistics/service-orders' className='text-danger fw-bold fs-6 mt-2'>
                Service Orders
              </a>
            </div>
            {/* end::Col */}
            ...
            <div className='col bg-light-success px-6 py-8 rounded-2'>
              ...
              />
              <a href='/statistics/calibration-reports' className='text-success fw-bold fs-6 mt-2'>
                Calibration Reports
              </a>
            </div>
            {/* end::Col */}
