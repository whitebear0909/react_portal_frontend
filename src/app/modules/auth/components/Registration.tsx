...
const Registration: FC<PropsFromRedux> = (props) => {
  ...
  return (
    ...
    >
      ...
      {/* begin::Form group Company id */}
      <div className='fv-row mb-7'>
        <label className='form-label fw-bolder text-dark fs-6'>Company ID</label>
        <input
          ...
          className={clsx(
            'form-control form-control-lg form-control-solid',
            {'is-invalid': formik.touched.companyId && formik.errors.companyId},
            {
              'is-valid': formik.touched.companyId && !formik.errors.companyId,
            }
          )}
        />
      ...
      {/* begin::Form group Customer ID */}
      <div className='fv-row mb-7'>
        <label className='form-label fw-bolder text-dark fs-6'>Customer ID</label>
        <input
